export const content = {
	bannerText: '<div>simple.</div><div>elegant.</div><div>effective.</div><div>rewarding.</div>',
	...
	workExperience: [
		{
			...
			responsibilities:
				'<p>Right on Day One at Rivers Agile, I joined a diverse team of talented and experienced developers on a large scale project with <span><b>IBM Pittsburgh Lab</b></span>. Our goal was to develop and work toward the release of an application called <b><i>Discovery Tooling</i></b>, which is an online tool in <b>IBM Watson™ Discovery</b> to help the users quickly set up an instance of the service and populate it with data.</p>' +
				...
				'<p>Currently, I am working with <span><b>FiCrowd</b></span>, who provide a white label, crowdfunding solution for banks and credit unions. My role is to develop and architect user interaction for their web application that provides high performance and scalable crowdfunding solutions via its innovative features.</p>',
			tags: ['React', 'Redux', 'SASS', 'Typescript', 'Node', 'Jest', 'Enzyme', 'Cypress', 'Ruby on rails', 'Angular 9', 'AWS Lambda', 'Git']
		},
		{
			...
			responsibilities:
				'<p>I landed my first job at Capgemini right after completing my undergraduate degree, where I joined as a Software Engineer in the .NET domain. After completing a 3 months training program in .NET framework, I joined a small team of 8 developers and worked with <span><b>Jetstar Airways Pty Ltd.</b></span></p>' +
			...
			tags: ['.NET', 'C#', 'ASP.NET', 'HTML5/CSS3', 'JavaScript', 'jQuery', 'Bootstrap', 'Oracle PL-SQL']
		}
	]
};
